...
function Detail({
 ...
 <p className={`text-slate-900 dark:text-white break-all transition-colors duration-300 ${mono ? 'font-mono text-sm bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-transparent px-3 py-2 ' : 'font-medium text-lg'}`}>
 {children}
 </p>
 </div>
 );
