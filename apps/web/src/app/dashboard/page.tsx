...
export default function Dashboard() {
 ...
 <div className="w-12 h-12 bg-red-100 dark:bg-red-500/10 flex items-center justify-center text-red-600 dark:text-red-400 mb-2">✕</div>
 ...
 <button onClick={reload} className="mt-4 px-6 py-3 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white text-sm font-bold hover:bg-slate-50 dark:hover:bg-white/10 hover:border-slate-300 transition-colors shadow-sm dark:shadow-none">
 Try Again
 </button>
 </div>
 )}
 ...
 <div className="flex flex-col items-center justify-center h-[400px] text-center space-y-4 px-6">
 <div className="w-12 h-12 bg-emerald-400 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-2 animate-pulse">●</div>
...
function TableSkeleton() {
 ...
 {[...Array(5)].map((_, i) => (
 <div key={i} className="h-12 bg-slate-100 dark:bg-white/5 animate-pulse transition-colors duration-300"/>
 ))}
 </div>
 );
}
