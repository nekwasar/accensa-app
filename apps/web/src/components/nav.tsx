...
export function Nav() {
 ...
 <img src="/accensa-logo-no-bg.png"alt="Accensa Logo"className="w-6 h-6 md:w-8 md:h-8 shadow-sm invert hue-rotate-180 dark:invert-0 dark:hue-rotate-0"/>
 ...
 type="button"
 >
 <span className={`w-6 h-0.5 transition-all duration-300 ${isOpen ? 'bg-white rotate-45 translate-y-1' : 'bg-slate-800 dark:bg-slate-100'}`} />
 <span className={`w-6 h-0.5 transition-all duration-300 ${isOpen ? 'bg-white -rotate-45 -translate-y-1' : 'bg-slate-800 dark:bg-slate-100'}`} />
 </button>
 ...
 >
 {/* eslint-disable-next-line @next/next/no-img-element */}
 <img src="/accensa-logo-no-bg.png"alt="Accensa Logo"className="w-7 h-7 shadow-sm invert hue-rotate-180 dark:invert-0 dark:hue-rotate-0"/>
 <span>Accensa<span className="text-emerald-600 dark:text-emerald-400 text-[1.3em] inline-block -ml-[0.05em] leading-none">.</span></span>
 </Link>
 </div>
